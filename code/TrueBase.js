...
exports.TrueBaseBuilder = exports.TrueBaseFolder = exports.TrueBaseFile = void 0;
...
exports.TrueBaseBuilder = TrueBaseBuilder;
class TrueBaseFile extends TreeNode {
    ...
    get linksToOtherFiles() {
        return lodash.uniq(this.parsed
            .getTopDownArray()
...
exports.TrueBaseFile = TrueBaseFile;
class TrueBaseFolder extends TreeNode {
    ...
    getFile(id) {
        if (id === undefined)
            return undefined;
        if (id.includes("/"))
            id = Utils.removeFileExtension(Disk.getFileName(id));
...
exports.TrueBaseFolder = TrueBaseFolder;
